<?
$wine_exec='/opt/wine-1.8/wine';

exec('export WINEARCH=win32');
	...
	$validatePrograms =array(
		...
		// digifly.com
		"vali-xdgi"			=>array("name"=>"","ok_result"=>9999,"ok_string"=>"PASSED"),			// ok ( fail -> -1 )			
...
//echo "#";
	...
	foreach($validatePrograms as $valProgram=>$valArray) {
		...
		if ( $CONF['os']=='linux') {
			...
			//$cmd="$wine_exec v:$valProgram v:".basename($igcFilename)." ";
