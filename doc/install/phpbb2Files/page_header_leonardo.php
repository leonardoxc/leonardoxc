 ...
 *
 *   $Id: page_header_leonardo.php,v 1.1 2006/12/14 00:55:05 manolis Exp $
 *
 *
 ***************************************************************************/
...
$Ltemplate = new LTemplate($moduleRelPath.'/templates/'.$PREFS->themeName.'/tpl');

$Ltemplate->set_filenames(array(
	'overall_header' => 'overall_header.html' )
);
