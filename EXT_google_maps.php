...
<script src="http://maps.google.com/maps?file=api&v=1&key=<?=$CONF_google_maps_api_key?>" type="text/javascript"></script>
</head>
<body>
...
//	map.addControl(new GSmallMapControl());
	...
	var takeoffPoint=new GPoint(<?=$wpLon?>,<?=$wpLat?>);

	map.centerAndZoom(takeoffPoint,4);
	takeoffMarker=createMarker(takeoffPoint,"<?=$wpName?>");
