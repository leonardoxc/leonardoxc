...
define("_TOO_LATE","El plazo de envío de este vuelo ha terminado y por lo tanto no puede ser enviado");
...
<p> Esto puede hacerlo <a href='http://www2.onlinecontest.org/olcphp/2005/ausw_wertung.php?olc=holc-i&spr=es' target='_blank'>
  en este sitio</a>, donde deberá seleccionar su país y luego 'Contest Registration'<br>
</p>
<p>Cuando haya finalizado el registro, debe ir a su 'Perfil del Piloto'->'Editar información OLC' e ingresar su información EXACTAMENTE como fué ingresada en el registro OLC
</p>
<ul>
...
define("_OLC_EXPLAINED","<b>¿Qué es OLC / para qué son estos campos ?</b><br><br>
	Para validar el envío a el OLC el piloto debe estar registrado en el sistema OLC.</p>
<p> Esto puede hacerlo <a href='http://www2.onlinecontest.org/olcphp/2005/ausw_wertung.php?olc=holc-i&spr=es' target='_blank'>
  en este sitio</a>, donde deberá seleccionar su país y luego 'Contest Registration'<br>
</p>
<p>Cuando haya completado el registro debe ingresar aquí la información EXACTAMENTE como fue ingresada en el registro OLC
</p>
<ul>
	<li><div align=left>Nombres</div>
...
Si no está seguro de que ingresar, aquí tiene un par de consejos:<p>
<ul>
<li>Use 4 letras en derivadas de su nombres / apellidos
<li>Intente buscar una combinación aleatoria. Esto reducirá la posibilidad de que su sufijo sea igual al de otros pilotos
