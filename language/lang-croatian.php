...
define("_NO_PILOT_OLC_DATA","<p><strong>Nema OLC podataka za pilota</strong><br>
  <br>
<b>Što je OLC / čemu služe ova polja ?</b><br><br>
	Za uspješnu predaju leta na OLC pilot treba već biti registriran na OLC sustavu.</p>
...
<p>Kad ste obavili registraciju, morate ići na 'Profil pilota'->'Izmijeni OLC podatke' i tamo unijeti svoje podatke na POTPUNO isti način kako ste ih unijeli pri OLC registraciji
</p>
<ul>
	<li><div align=left>Ime</div>
	<li><div align=left>Prezime</div>
	<li><div align=left>Datum rođenja</div>
	<li> <div align=left>Nadimak</div>
	<li><div align=left>Ako ste već predavali letove na OLC, 4 slova koja koristite za ime IGC datoteke</div>
</ul>");
...
define("_OLC_EXPLAINED","<b>Što je OLC / što znače ova polja ?</b><br><br>
	Za uspješnu predaju leta na OLC pilot treba već biti registriran na OLC sustavu.</p>
To se može napraviti <a href='http://www2.onlinecontest.org/olcphp/2005/ausw_wertung.php?olc=holc-i&spr=en' target='_blank'>
  na ovoj stranici</a>, gdje morate prvo odabrati svoju državu, a onda 'Contest Registration'<br>
</p>
<p>Kad ste obavili registraciju, ovdje morate unijeti svoje podatke na POTPUNO isti način kako ste ih unijeli pri OLC registraciji
</p>
<ul>
	<li><div align=left>Ime</div>
	<li><div align=left>Prezime</div>
...
define("_OLC_SUFFIX_EXPLAINED","<b>Što je 'Nastavak IGC datoteke?'</b><br>To je 4 slova dugačak id koji jednoznačno određuje pilota ili letjelicu. 
Ako želite savjet što unijeti na to mjesto, ovdje su neki prijedlozi:<p>
<ul>
<li>Koristite 4 slova iz svog imena i prezimena (Ivo Perić - IPER)
<li>Pokušajte naći neobičnu kombinaciju kako bi smanjili vjerojatnost da će je koristiti i neki drugi pilot.
