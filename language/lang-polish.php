...
define("_PHOTOS_GUIDELINES","Zdjęcia powinny być w formacie jpg i nie większe niż 100Kb");
...
define("_SUBMIT_TO_OLC","Wyślij do OLC");
define("_YOUR_FLIGHT_HAS_BEEN_SUCCESSFULLY_SUBMITED_TO_THE_OLC","Lot został pomyślnie przesłany na serwer OLC");
define("_THE_OLC_REFERENCE_NUMBER_IS","Numer referencyjny OLC:");
define("_THERE_WAS_A_PROBLEM_ON_OLC_SUBMISSION","Podczas przesyłania lotu na serwer OLC wystąpił błąd!");
define("_LOOK_BELOW_FOR_THE_CAUSE_OF_THE_PROBLEM","Przyczyna błędu została podana poniżej");
define("_FLIGHT_SUCCESFULLY_REMOVED_FROM_OLC","Lot został usunięty z serwera OLC");
define("_FLIGHT_NOT_SCORED","Lot nie jest punktowany i nie może zostać zgłoszony");
define("_TOO_LATE","Minął ostateczny termin przesłania lotu i nie może on być zgłoszony");
define("_CANNOT_BE_SUBMITTED","Minął ostateczny termin przesłania lotu");
define("_NO_PILOT_OLC_DATA","<p><strong>Brak danych pilota w bazie OLC</strong><br>
  <br>
<b>Czym jest OLC / Do czego służą te pola ?</b><br><br>
	Aby lot mógł zostać zgłoszony, pilot musi być uprzednio zarejestrowany w systemie OLC.</p>
<p> Można tego dokonać <a href='http://www2.onlinecontest.org/olcphp/2005/ausw_wertung.php?olc=holc-i&spr=en' target='_blank'>
  na tej stronie</a>, gdzie należy wybrać swój kraj, a następnie wybrać 'Contest Registration'<br>
</p>
<p>Po zakończeniu rejestracji w OLC, należy przejść do menu 'Profil pilota'->'Edytuj dane OLC' i wpisać DOKŁADNIE takie same dane, jak podczas rejestracji do OLC
</p>
<ul>
	<li><div align=left>Imię</div>
	<li><div align=left>Nazwisko</div>
	<li><div align=left>Data urodzenia</div>
	<li> <div align=left>Callsign</div>
	<li><div align=left>Jeśli pilot przesyłał już loty do OLC, 4 litery, które wpisuje na końcu pliku IGC</div>
</ul>");
...
define("_OLC_EXPLAINED","<b>Czym jest OLC / Do czego służą te pola ?</b><br><br>
	Aby lot mógł zostać zgłoszony, pilot musi być uprzednio zarejestrowany w systemie OLC.</p>
<p> Można tego dokonać <a href='http://www2.onlinecontest.org/olcphp/2005/ausw_wertung.php?olc=holc-i&spr=en' target='_blank'>
  na tej stronie</a>, gdzie należy wybrać swój kraj, a następnie wybrać 'Contest Registration'<br>
</p>
<p>Po zakończeniu rejestracji należy wpisać tutaj DOKŁADNIE takie same dane, jak podczas rejestracji do OLC
</p>
<ul>
	<li><div align=left>Imię</div>
	<li><div align=left>Nazwisko</div>
...
define("_OLC_SUFFIX_EXPLAINED","<b>Czym jest 'Sufiks pliku IGC?'</b><br>Jest to czteroliterowy identyfikator, unikatowy dla danego pilota lub skrzydła. 
Jeśli nie wiadomo, co tutaj wpisać, oto kilka wskazówek:<p>
<ul>
<li>Pierwsze litery imienia i nazwiska
<li>Należy szukać oryginalnych kombinacji. Dzięki temu ograniczymy szansę, że taki sam sufiks będzie użyty przez innego pilota.
<li>Jeśli przy przesyłaniu lotów do OLC przez serwer Leonardo pojawiają się problemy, może być to kwestia złego sufiksu. Można spróbować go zmienić i przesłać ponownie.
</ul>");
//--------------------------------------------
