...
function setMonths() {
	...
	$monthList=array('一月','二月','三月','四月','五月','六月',
					'七月','八月','九月','十月','十一月','十二月');
	$monthListShort=array('1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月');
	$weekdaysList=array('一','二','三','四','五','六','日') ;
}
setMonths();
define("_FLIGHTS_","飞行记录");
//--------------------------------------------
// output.php
//--------------------------------------------
...
// show flight
define("_FLIGHT_WILL_BE_ACTIVATED_SOON","上传轨迹在1-2分钟内生效");
...
// index.php
//--------------------------------------------
define("_PAGE_TITLE","在线联赛");
define("_RETURN_TO_TOP","回到顶端");
// list flight
define("_PILOT_FLIGHTS","飞行员的飞行");

define("_DATE_SORT","日期");
define("_PILOT_NAME","飞行员名称");
define("_TAKEOFF","起飞");
...
// add flight
define("_YOU_HAVENT_SUPPLIED_A_FLIGHT_FILE","您还没提交飞行轨迹文件");
...
define("_YOUR_FLIGHT_HAS_BEEN_SUBMITTED","您的飞行轨迹已经递交");
define("_PRESS_HERE_TO_VIEW_IT","点击这里转入观看");
define("_WILL_BE_ACTIVATED_SOON","(飞行记录将在1-2分钟内生效)");

// add_from_zip
define("_SUBMIT_MULTIPLE_FLIGHTS","上传多个飞行轨迹记录");
define("_ONLY_THE_IGC_FILES_WILL_BE_PROCESSED","只能运行IGC文件");
define("_SUBMIT_THE_ZIP_FILE_CONTAINING_THE_FLIGHTS","上传多个飞行的ZIP文件<br>");
define("_PRESS_HERE_TO_SUBMIT_THE_FLIGHTS","点击这里上传轨迹");

define("_FILE_DOESNT_END_IN_ZIP","文件不是.zip后缀");
define("_ADDING_FILE","正在上传文件");
define("_ADDED_SUCESSFULLY","上传成功");
define("_PROBLEM","问题");
define("_TOTAL","总计");
define("_IGC_FILES_PROCESSED","IGC文件已经处理完毕");
define("_IGC_FILES_SUBMITED","IGC文件已经上传完毕");

// info
define("_DEVELOPMENT","程序开发");
define("_ANDREADAKIS_MANOLIS","Andreadakis Manolis");
define("_PROJECT_URL","程序链接");
define("_VERSION","版本");
...
define("_MENU_FLIGHTS","飞行记录");
define("_MENU_TAKEOFFS","起飞场");
define("_MENU_FILTER","筛选飞行记录");
define("_MENU_MY_FLIGHTS","我的飞行记录");
define("_MENU_MY_PROFILE","我的个人资料");
define("_MENU_MY_STATS","我的飞行统计"); 
define("_MENU_MY_SETTINGS","我的设置"); 
define("_MENU_SUBMIT_FLIGHT","上传飞行记录");
define("_MENU_SUBMIT_FROM_ZIP","由ZIP文件上传飞行");
define("_MENU_SHOW_PILOTS","飞行员列表");
...
define("_THE_FLIGHT_HAS_BEEN_DELETED","飞行记录已经被删除");
define("_RETURN","返回");
define("_CAUTION_THE_FLIGHT_WILL_BE_DELETED","注意-你正要删除此次飞行记录");
define("_THE_DATE","日期 ");
define("_YES","是");
define("_NO","否");
...
define("_OR","或");
define("_AND","和");
define("_FILTER_PAGE_TITLE","筛选飞行记录");
...
define("_SUBMIT_FLIGHT","上传飞行记录");
define("_ONLY_THE_IGC_FILE_IS_NEEDED","(只接受IGC格式文件)");
define("_SUBMIT_THE_IGC_FILE_FOR_THE_FLIGHT","上传IGC飞行文件");
define("_NOTE_TAKEOFF_NAME","请填写起飞场的信息");
define("_COMMENTS_FOR_THE_FLIGHT","飞行注释");
define("_PHOTO","照片");
define("_PHOTOS_GUIDELINES","照片应是jpg格式并小于");
define("_PRESS_HERE_TO_SUBMIT_THE_FLIGHT","上传飞行记录");
define("_DO_YOU_HAVE_MANY_FLIGHTS_IN_A_ZIPFILE","你想一次上传多个飞行记录吗?");
define("_PRESS_HERE","请点击这里");

define("_IS_PRIVATE","不要公开展示");
define("_MAKE_THIS_FLIGHT_PRIVATE","不公开展示");
define("_INSERT_FLIGHT_AS_USER_ID","填写该飞行记录所属的用户ID");
define("_FLIGHT_IS_PRIVATE","此次飞行记录保密");

//--------------------------------------------
// edit_flight.php
//--------------------------------------------

define("_CHANGE_FLIGHT_DATA","修改飞行记录");
define("_IGC_FILE_OF_THE_FLIGHT","飞行的IGC文件");
define("_DELETE_PHOTO","删除");
define("_NEW_PHOTO","新增照片");
define("_PRESS_HERE_TO_CHANGE_THE_FLIGHT","点击修改飞行记录");
define("_THE_CHANGES_HAVE_BEEN_APPLIED","修改已经生效");
define("_RETURN_TO_FLIGHT","返回此飞行记录");
...
// pilot_profile.php
//--------------------------------------------
define("_Pilot_Profile","飞行员个人资料");
define("_back_to_flights","返回飞行记录");
define("_pilot_stats","飞行员统计");
define("_edit_profile","编辑个人资料");
define("_flights_stats","飞行统计");
define("_View_Profile","查看个人资料");
...
define("_Your_profile_has_been_updated","您的信息已上传");
...
define("_Navigate","导航");
define("_COORDINATES","坐标");
define("_FLIGHTS","飞行");
define("_SITE_RECORD","场地记录");
define("_SITE_INFO","场地信息");
define("_SITE_REGION","所属区域");
define("_SITE_LINK","链接更多的信息");
define("_SITE_DESCR","场地描述");

//--------------------------------------------
// KML file
//--------------------------------------------
define("_See_more_details","查看更详细信息");
define("_KML_file_made_by","KML文件生成");

//--------------------------------------------
// add_waypoint.php
//--------------------------------------------
define("_ADD_WAYPOINT","录入起飞场");
define("_WAYPOINT_ADDED","起飞场已录入");

//--------------------------------------------
// list_takeoffs.php
//--------------------------------------------
define("_SITE_RECORD_OPEN_DISTANCE","场地记录(开放距离)");
	
//--------------------------------------------
// glider types
//--------------------------------------------
define("_GLIDER_TYPE","飞行器类型");
function setGliderCats() {
	global  $CONF_glider_types,$gliderCatList;
	$gliderCatList=array(1=>'滑翔伞',2=>'Flex三角翼 FAI1',4=>'Rigid三角翼 FAI5',8=>'滑翔机',
			16=>"动力伞", 64=>"飞机");
...
function setClassList() {
	$CONF_TEMP['gliderClasses'][1]['classes']=array(1=>"运动",2=>"开放",3=>"双人");
...
function setXCtypesList() {
	...
	$xcTypesList=array(1=>"3翻转点 XC",2=>"开放式三角航线",4=>"闭合式三角航线");
...
define("_Your_settings_have_been_updated","设置已上传");
...
define("_WORLD_WIDE","全球所有地区");
define("_National_XC_Leagues_for","点击地区列出赛事结果");
define("_Flights_per_Country","点击地区列出飞行记录");
define("_Takeoffs_per_Country","点击地区列出场地信息");
define("_INDEX_HEADER","欢迎访问滑翔中国在线联赛");
define("_INDEX_MESSAGE"," ");

//--------------------------------------------
// NEW 
//--------------------------------------------
define("_MENU_SUMMARY_PAGE","摘要");
...
define("_give_at_least_2_letters","至少输入2个字");
...
define("_DELETE_WAYPOINT","删除起飞场信息");
define("_SUBMISION_DATE","上传日期"); // the date a flight was submited to leonardo
define("_TIMES_VIEWED","查看次数"); // the times that this flight havs been viewed
...
define("_In_Local_Language","用中文");
define("_In_English","用英语");
define("_In_Chinese","用中文");
...
define("_Pilot_Statistics","按飞行员成绩排序");
...
define("_PROJECT_HELP","帮助"); 
define("_PROJECT_NEWS","新闻"); 
define("_PROJECT_RULES","Regulations 2007"); 
define("_Filter_NoSelection","无任何选择"); 
define("_Filter_CurrentlySelected","当前选择"); 
define("_Filter_DialogMultiSelectInfo","按住 Ctrl 键选择多个."); 
...
define("_Filter_Items_pilot","飞行员");
define("_Filter_Items_nacclub","俱乐部");
define("_Filter_Items_country","国家");
define("_Filter_Items_takeoff","起飞场");
define("_Filter_Button_Select","选择");
define("_Filter_Button_Delete","删除");
define("_Filter_Button_Accept","确认选择");
define("_Filter_Button_Cancel","取消");
define("_MENU_FILTER_NEW","Filter **NEW VERSION**"); 
define("_ALL_NACCLUBS","所有俱乐部"); 
...
define("_Select_Brand","选择品牌"); 
define("_All_Brands","全部品牌"); 
define("_DAY","日"); 
define("_Glider_Brand","品牌"); 
define("_Or_Select_from_previous","从以前记录中选择"); 
...
define("_Male_short","男"); 
define("_Female_short","女"); 
define("_Male","男"); 
define("_Female","女"); 
define("_Altitude_Short","高度"); 
define("_Vario_Short","速率"); 
define("_Time_Short","时间"); 
define("_Info","信息"); 
define("_Control","控制"); 
define("_Zoom_to_flight","聚焦到飞行轨迹"); 
define("_Follow_Glider","跟随轨迹"); 
define("_Show_Task","显示任务"); 
define("_Show_Airspace","显示空域"); 
define("_Thermals","热气流"); 
define("_Show_Optimization_details","显示优化细节"); 
define("_MENU_SEARCH_PILOTS","查找飞行员"); 
define("_MemberID_Missing","Your member ID is missing"); 
define("_MemberID_NotNumeric","The member ID must be numeric"); 
define("_FLIGHTADD_CONFIRMATIONTEXT","请您务必确保此次上传的记录都是真实有效的。 "); 
...
define("_You_are_not_login","<BR><BR><center><br>对不起，请先登录.<a href='index.php?name=leonardo&op=login'>点击登录</a><BR><BR></center>"); 
...
Note: This is auto-response. Do not send any email to this email address
--------"); 
define("_MENU_AREA_GUIDE","地区指南"); 
define("_All_XC_types","全部 XC 类型"); 
define("_xctype","XC 类型"); 
...
define("_choose_ge_module","请点击选择要在谷歌地球中使用的模组"); 
define("_ge_module_advanced_1","最详细,文件最大"); 
define("_ge_module_advanced_2","较详细,文件较大"); 
define("_ge_module_Simple","精简显示,文件较小"); 
define("_Pilot_search_instructions","请输入至少三个英文字符，或者两个汉字"); 
define("_All_classes","所有类别"); 
define("_Class","Class"); 
define("_Photos_filter_off","不管是否含照片都显示"); 
define("_Photos_filter_on","仅显示含照片的"); 
...
define("_Start_Type","起飞助力类别"); 
define("_GLIDER_CERT","伞具认证"); 
...
define("_Find_and_Compare_Flights","查找、对比飞行记录"); 
define("_Compare_Selected_Flights","对比所选的飞行记录"); 
define("_Compare_Flights","对比飞行记录");
define("_More","更多"); 
define("_Close","关闭"); 
define("_Sync_Start_Times","同步开始时间"); 

define('_Scoring_Factors_Used','使用的计分系数');
define('_Type_of_Flight','飞行类型');
define('_Factor','系数');
define('_distance','距离');
define('_Score','分数');
define('_View_my_flight_rec','查看我上传的轨迹');
define('_Site_title','滑翔中国');
define('_Google_Earth','谷歌地球');
