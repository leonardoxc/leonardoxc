...
function setMonths() {
	...
	$monthList=array('Janeiro','Fevereiro','Marзo','Abril','Maio','Junho',
...
// output.php
//--------------------------------------------
define("_FREE_FLIGHT","Distвncia livre");
define("_FREE_TRIANGLE","Triвngulo livre");
define("_FAI_TRIANGLE","Triвngulo FAI");
...
define("_NUMBER_OF_FLIGHTS","Nъmero de vфos");
define("_BEST_DISTANCE","Melhor distвncia");
define("_MEAN_KM","Mйdia km por vфo");
define("_TOTAL_KM","Km Totais voados");
define("_TOTAL_DURATION_OF_FLIGHTS","Duraзгo total dos vфos");
define("_MEAN_DURATION","Duraзгo mйdia dos vфos");
define("_TOTAL_OLC_KM","Distвncia OLC total");
define("_TOTAL_OLC_SCORE","Pontuaзгo OLC total");
define("_BEST_OLC_SCORE","Melhor pontuaзгo OLC");
define("_From","de");

// list_flights()
define("_DURATION_HOURS_MIN","Duraзгo (h:m)");
define("_SHOW","Mostrar");

// show flight
define("_FLIGHT_WILL_BE_ACTIVATED_SOON","O voo serб activado dentro de 1-2 minutos.");
...
define("_OPEN_DISTANCE","Distвncia livre");
define("_MAX_DISTANCE","Distвncia mбxima");
define("_OLC_SCORE_TYPE","Tipo de pontuaзгo OLC");
define("_OLC_DISTANCE","Distвncia OLC");
define("_OLC_SCORING","Pontuaзгo OLC");
define("_MAX_SPEED","Velocidade mбxima");
define("_MAX_VARIO","Maior Ascendente");
define("_MEAN_SPEED","Velocidade mйdia");
define("_MIN_VARIO","Maior descendente");
define("_MAX_ALTITUDE","Altitude mбxima");
define("_TAKEOFF_ALTITUDE","Altitude da decolagem");
define("_MIN_ALTITUDE","Altitude mнnima");
define("_ALTITUDE_GAIN","Ganho de altitude");
define("_FLIGHT_FILE","Arquivo do vфo");
define("_COMMENTS","Comentбrios");
define("_RELEVANT_PAGE","Endereзo da pбgina web relacionada");
define("_GLIDER","Asa");
define("_PHOTOS","Fotos");
define("_MORE_INFO","Informaзгo adicional");
define("_UPDATE_DATA","Atualizar dados");
define("_UPDATE_MAP","Atualizar mapa");
define("_UPDATE_3D_MAP","Atualizar mapa 3D");
define("_UPDATE_GRAPHS","Atualizar grбficos");
define("_UPDATE_SCORE","Atualizar pontuaзгo");

define("_TAKEOFF_COORDS","Coordenadas da decolagem:");
define("_NO_KNOWN_LOCATIONS","Nгo existem locais conhecidos!");
define("_FLYING_AREA_INFO","Informaзгo do local de vфo");

//--------------------------------------------
// index.php
//--------------------------------------------
define("_PAGE_TITLE","Leonardo XC");
define("_RETURN_TO_TOP","Voltar para o inнcio");
// list flight
define("_PILOT_FLIGHTS","Vфos do piloto");

define("_DATE_SORT","Data");
define("_PILOT_NAME","Nome do piloto");
define("_TAKEOFF","Decolagem");
define("_DURATION","Duraзгo");
define("_LINEAR_DISTANCE","Distвncia em linha reta");
define("_OLC_KM","OLC km");
define("_OLC_SCORE","Pontuaзгo OLC");
define("_DATE_ADDED","Ъltimo envio");

define("_SORTED_BY","Ordenar por:");
define("_ALL_YEARS","Todos os anos");
define("_SELECT_YEAR_MONTH","Selecionar ano e mкs");
define("_ALL","Todos");
...
// add flight
define("_YOU_HAVENT_SUPPLIED_A_FLIGHT_FILE","Vocк nгo enviou um arquivo de vфo");
define("_NO_SUCH_FILE","O arquivo enviado nгo foi encontrado no servidor");
define("_FILE_DOESNT_END_IN_IGC","O arquivo nгo tem extensгo .igc");
define("_THIS_ISNT_A_VALID_IGC_FILE","Este nгo й um arquivo vбlido .igc");
define("_THERE_IS_SAME_DATE_FLIGHT","Jб existe um vфo com a mesma data e hora");
define("_IF_YOU_WANT_TO_SUBSTITUTE_IT","Se deseja substitui-lo deverб antes");
define("_DELETE_THE_OLD_ONE","apagar o anterior");
define("_THERE_IS_SAME_FILENAME_FLIGHT","Jб existe um vфo arquivado com o mesmo nome");
define("_CHANGE_THE_FILENAME","Se este vфo й diferente mude o nome do arquivo e tente novamente");
define("_YOUR_FLIGHT_HAS_BEEN_SUBMITTED","O vфo foi enviado com sucesso");
define("_PRESS_HERE_TO_VIEW_IT","Visualizar aqui");
define("_WILL_BE_ACTIVATED_SOON","(Serб ativado dentro de 1-2 minutos)");

// add_from_zip
define("_SUBMIT_MULTIPLE_FLIGHTS","Enviar vбrios vфos");
define("_ONLY_THE_IGC_FILES_WILL_BE_PROCESSED","Apenas serгo processados arquivos IGC");
define("_SUBMIT_THE_ZIP_FILE_CONTAINING_THE_FLIGHTS","Enviar arquivo ZIP contendo os vфos");
define("_PRESS_HERE_TO_SUBMIT_THE_FLIGHTS","Pressione aqui para enviar os vфos");

define("_FILE_DOESNT_END_IN_ZIP","O arquivo enviado nгo tem extensгo .zip");
define("_ADDING_FILE","Enviando arquivo");
define("_ADDED_SUCESSFULLY","Envio terminado");
define("_PROBLEM","Problema");
define("_TOTAL","Total");
define("_IGC_FILES_PROCESSED","Os vфos foram processados");
define("_IGC_FILES_SUBMITED","Os vфos foram enviados");

// info
define("_DEVELOPMENT","Desenvolvido por");
define("_ANDREADAKIS_MANOLIS","Andreadakis Manolis");
define("_PROJECT_URL","Website do projeto");
define("_VERSION","Versгo");
define("_MAP_CREATION","Criaзгo de mapas");
define("_PROJECT_INFO","Informaзгo sobre o projeto");

// menu bar 
define("_MENU_MAIN_MENU","Menu principal");
define("_MENU_DATE","Selecionar data");
define("_MENU_COUNTRY","Selecionar Paнs");
define("_MENU_XCLEAGUE","Liga XC");
define("_MENU_ADMIN","Admin");

define("_MENU_COMPETITION_LEAGUE","Liga - todas as categorias");
define("_MENU_OLC","OLC");
define("_MENU_OPEN_DISTANCE","Distвncia livre");
define("_MENU_DURATION","Duraзгo");
define("_MENU_ALL_FLIGHTS","Mostrar todos os vфos");
define("_MENU_FLIGHTS","Vфos");
define("_MENU_TAKEOFFS","Decolagem");
define("_MENU_FILTER","Filtro");
define("_MENU_MY_FLIGHTS","Meus vфos");
define("_MENU_MY_PROFILE","Meu perfil");
define("_MENU_MY_STATS","Minhas estatнsticas"); 
define("_MENU_MY_SETTINGS","Minhas definiзхes"); 
define("_MENU_SUBMIT_FLIGHT","Enviar vфo");
define("_MENU_SUBMIT_FROM_ZIP","Enviar vфos zip");
define("_MENU_SHOW_PILOTS","Mostrar pilotos");
define("_MENU_SHOW_LAST_ADDED","Mostrar envios recentes");
define("_FLIGHTS_STATS","Estatнsticas do vфo");

define("_SELECT_YEAR","Selecionar ano");
define("_SELECT_MONTH","Selecionar mкs");
define("_ALL_COUNTRIES","Mostrar todos os paнses");
//--------------------------------------------
// list_pilots.php
//--------------------------------------------
...
define("_NUMBER_OF_FLIGHTS","Nъmero de vфos");
define("_TOTAL_DISTANCE","Distвncia total");
define("_TOTAL_DURATION","Duraзгo total");
define("_BEST_OPEN_DISTANCE","Melhor distвncia");
define("_TOTAL_OLC_DISTANCE","Distвncia total OLC");
define("_TOTAL_OLC_SCORE","Pontuaзгo total OLC");
define("_BEST_OLC_SCORE","Melhor pontuaзгo OLC");
define("_MEAN_DURATION","Duraзгo mйdia");
define("_MEAN_DISTANCE","Distвncia mйdia");
define("_PILOT_STATISTICS_SORT_BY","Pilotos - Ordenar por");
define("_CATEGORY_FLIGHT_NUMBER","Categoria - Nъmero de voos");
define("_CATEGORY_TOTAL_DURATION","Categoria - Duraзгo total");
define("_CATEGORY_OPEN_DISTANCE","Categorнa - Distвncia livre");
define("_THERE_ARE_NO_PILOTS_TO_DISPLAY","Nгo existem pilotos para mostrar!");
...
define("_THE_FLIGHT_HAS_BEEN_DELETED","O vфo foi apagado");
define("_RETURN","Voltar");
define("_CAUTION_THE_FLIGHT_WILL_BE_DELETED","ATENЗГO - O vфo vai ser apagado");
...
define("_N_BEST_FLIGHTS","Melhores vфos");
define("_OLC","OLC");
define("_OLC_TOTAL_SCORE","Pontuaзгo total OLC");
...
define("_IS","й");
define("_IS_NOT","nгo й");
define("_OR","ou");
define("_AND","e");
define("_FILTER_PAGE_TITLE","Filtro de vфos");
define("_RETURN_TO_FLIGHTS","Voltar aos vфos");
define("_THE_FILTER_IS_ACTIVE","O filtro estб ativo");
define("_THE_FILTER_IS_INACTIVE","O filtro estб inativo");
define("_SELECT_DATE","Seleccionar data");
define("_SHOW_FLIGHTS","Mostrar vфos");
define("_ALL2","TODOS");
...
define("_THE_COUNTRY","O paнs");
define("_COUNTRY","Paнs");
define("_SELECT_COUNTRY","Selecionar paнs");
define("_OTHER_FILTERS","Outros filtros");
define("_LINEAR_DISTANCE_SHOULD_BE","A distвncia livre deve ser");
define("_OLC_DISTANCE_SHOULD_BE","A distвncia OLC deve ser");
define("_OLC_SCORE_SHOULD_BE","A pontuaзгo OLC deve ser");
define("_DURATION_SHOULD_BE","A duraзгo deve ser");
...
define("_SUBMIT_FLIGHT","Enviar vфo");
define("_ONLY_THE_IGC_FILE_IS_NEEDED","(sу й necessбrio o arquivo IGC)");
define("_SUBMIT_THE_IGC_FILE_FOR_THE_FLIGHT","Enviar o arquivo IGC do vфo");
define("_NOTE_TAKEOFF_NAME","Por favor escreva o nome da decolagem e paнs");
define("_COMMENTS_FOR_THE_FLIGHT","Comentбrios sobre o vфo");
define("_PHOTO","Foto");
define("_PHOTOS_GUIDELINES","As fotos devem estar em formato jpg e ter tamhno inferior a ");
define("_PRESS_HERE_TO_SUBMIT_THE_FLIGHT","Pressionar aqui para enviar o vфo");
define("_DO_YOU_HAVE_MANY_FLIGHTS_IN_A_ZIPFILE","їPretende enviar diversos vфos simultaneamente?");
define("_PRESS_HERE","Pressionar aqui");

define("_IS_PRIVATE","Nгo mostrar ao pъblico");
define("_MAKE_THIS_FLIGHT_PRIVATE","Nгo mostrar ao pъblico");
define("_INSERT_FLIGHT_AS_USER_ID","Introduzir o vфo como ID do utilizador");
define("_FLIGHT_IS_PRIVATE","Este vфo й privado");

//--------------------------------------------
// edit_flight.php
//--------------------------------------------

define("_CHANGE_FLIGHT_DATA","Mudar dados do vфo");
define("_IGC_FILE_OF_THE_FLIGHT","Arquivo IGC do vфo");
define("_DELETE_PHOTO","Apagar foto");
define("_NEW_PHOTO","Nova foto");
define("_PRESS_HERE_TO_CHANGE_THE_FLIGHT","Pressione aqui para modificar os dados do vфo");
define("_THE_CHANGES_HAVE_BEEN_APPLIED","As modificaзхes foram efetuadas com sucesso");
define("_RETURN_TO_FLIGHT","Voltar ao vфo");
...
define("_pilot_stats","Estatнsticas do piloto");
define("_edit_profile","Editar perfil");
define("_flights_stats","Estatнsticas do voo");
...
define("_Occupation","Ocupaзгo");
define("_Web_Page","Pбgina Web");
define("_N_A","N/A");
define("_Other_Interests","Outros Interesses");
define("_Photo","Foto");

define("_Flying_Stuff","Dados de vфo");
define("_note_place_and_date","se possнvel acrescentar cidade, paнs e data");
define("_Flying_Since","Voando desde");
define("_Pilot_Licence","Licenзa de vфo");
define("_Paragliding_training","Experiкncia de vфo");
define("_Favorite_Location","Local de vфo favorito");
define("_Usual_Location","Local de vфo habitual");
define("_Best_Flying_Memory","Melhor experiкncia em vфo");
define("_Worst_Flying_Memory","Pior experiкncia em vфo");
define("_Personal_Distance_Record","Recorde pessoal de distвncia");
define("_Personal_Height_Record","Recorde pessoal de altitude");
define("_Hours_Flown","Horas de vфo");
define("_Hours_Per_Year","Horas voadas anualmente");

define("_Equipment_Stuff","Dados sobre o Equipamento");
define("_Glider","Asa");
define("_Harness","Selete");
define("_Reserve_chute","Paraquedas de emergкncia");
define("_Camera","Cвmera fotogrбfica");
define("_Vario","Vбrio");
define("_GPS","GPS");
define("_Helmet","Capacete");
define("_Camcorder","Cвmera de vнdeo");

define("_Manouveur_Stuff","Dados sobre manobras de vфo");
define("_note_max_descent_rate","se possнvel acrescentar a taxa de queda mбxima alcanзada");
define("_Spiral","Espiral");
define("_Bline","Estol de B");
define("_Full_Stall","Full Stall");
define("_Other_Manouveurs_Acro","Outras manobras Acro");
define("_Sat","Sat");
define("_Asymmetric_Spiral","Espiral assimйtrica");
...
define("_First_flight_logged","Primeiro vфo introduzido");
define("_Last_flight_logged","Ъltimo vфo introduzido");
define("_Flying_period_covered","Perнodo de vфo coberto");
define("_Total_Distance","Distвncia total");
define("_Total_OLC_Score","Pontuaзгo total OLC");
define("_Total_Hours_Flown","Total de horas de vфo");
define("_Total_num_of_flights","Nъmero total de vфos");

define("_Personal_Bests","Melhores resultados pessoais");
define("_Best_Open_Distance","Melhor distвncia livre");
define("_Best_FAI_Triangle","Melhor triвngulo FAI");
define("_Best_Free_Triangle","Mejor triвngulo livre");
define("_Longest_Flight","Vфo mais longo");
define("_Best_OLC_score","Melhor pontuaзгo OLC");

define("_Absolute_Height_Record","Recorde de altitude absoluta");
define("_Altitute_gain_Record","Recorde de ganho de altitude");
define("_Mean_values","Valores mйdios");
define("_Mean_distance_per_flight","Distвncias mйdias por vфo");
define("_Mean_flights_per_Month","Mйdia de vфos por mкs");
define("_Mean_distance_per_Month","Mйdia de distвncia por mкs");
define("_Mean_duration_per_Month","Mйdia da duraзгo de vфo por mкs");
define("_Mean_duration_per_flight","Mйdia da duraзгo por vфo");
define("_Mean_flights_per_Year","Mйdia de vфos por ano");
define("_Mean_distance_per_Year","Mйdia de distвncias por ano");
define("_Mean_duration_per_Year","Mйdia de duraзгo de vфo por ano");

//--------------------------------------------
// show_waypoint.php
//--------------------------------------------
define("_See_flights_near_this_point","Ver vфos prуximos a este ponto");
...
define("_FLIGHTS","Vфos");
define("_SITE_RECORD","Recorde local");
define("_SITE_INFO","Informaзгo sobre o local de vфo");
define("_SITE_REGION","Regiгo");
define("_SITE_LINK","Link com mais informaзгo");
define("_SITE_DESCR","Descriзгo do local de vфo/Decolagem");
...
// list_takeoffs.php
//--------------------------------------------
define("_SITE_RECORD_OPEN_DISTANCE","Recorde local de (distвncia livre)");
...
function setGliderCats() {
	...
	$gliderCatList=array(1=>'Parapente',2=>'Asa delta FAI1',4=>'Asa rнgida FAI5',8=>'Planador');
...
define("_VIEW_COUNTRY","Ver paнs");
define("_UNITS_SYSTEM" ,"Unidades");
define("_METRIC_SYSTEM","Mйtrico (km,m)");
define("_IMPERIAL_SYSTEM","Imperial (milhas,pйs)");
define("_ITEMS_PER_PAGE","Items por pбgina");
...
define("_Flights_per_Country","Vфos por Paнs");
define("_Takeoffs_per_Country","Descolagens por Paнs");
define("_INDEX_HEADER","Bem vindo а Liga XC Leonardo");
define("_INDEX_MESSAGE","Utilize o menu principal para navegar ou as preferкncias a seguir.");
