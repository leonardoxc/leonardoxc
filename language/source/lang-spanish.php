...
define("_PRESS_HERE_TO_VIEW_IT","Presion� aqu� para verlo");
...
define("_PRESS_HERE_TO_SUBMIT_THE_FLIGHTS","Presion� aqu� para enviar los vuelos");
...
define("_NOTE_TAKEOFF_NAME","Por favor anot� el nombre del despegue, ubicaci�n y pa�s");
...
define("_PRESS_HERE_TO_SUBMIT_THE_FLIGHT","Presion� aqu� para enviar el vuelo");
define("_DO_YOU_HAVE_MANY_FLIGHTS_IN_A_ZIPFILE","�Quer�s enviar varios vuelos juntos?");
define("_PRESS_HERE","Clique� aqu�");
...
define("_PRESS_HERE_TO_CHANGE_THE_FLIGHT","Presion� aqu� para cambiar los datos del vuelo");
