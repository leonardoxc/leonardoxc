...
// show flight
define("_FLIGHT_WILL_BE_ACTIVATED_SOON","Uçuş 1-2 dakika içinde aktif 
olacaktır. ");
...
define("_WILL_BE_ACTIVATED_SOON","(uçuş kaydınız 1-2 dakika içinde aktif 
olacaktır)");

// add_from_zip
define("_SUBMIT_MULTIPLE_FLIGHTS","Birden fazla uçuş kaydı gönder");
define("_ONLY_THE_IGC_FILES_WILL_BE_PROCESSED",".zip dosyasının içindeki 
sadece .igc dosyaları işlenir.");
define("_SUBMIT_THE_ZIP_FILE_CONTAINING_THE_FLIGHTS","Uçuşları içeren<br>zip 
dosyası gönder");
...
define("_ONLY_THE_IGC_FILE_IS_NEEDED","(Sadece .IGC dosyası gerekli , diğer
alanlar boş bırakılabilir<br><b> .igc dosyası oluşturmakla ilgili rehber
yazıyı okumak için <a href=http://www.ypforum.com/viewtopic.php?t=226
target=_blank >Tıklayın</a></b>)");
define("_SUBMIT_THE_IGC_FILE_FOR_THE_FLIGHT","IGC dosyasını seçiniz");
define("_NOTE_TAKEOFF_NAME","<font size=1>Kalkış Pistinin adını veya ülkeyi
yazabilirsiniz</font>");
define("_COMMENTS_FOR_THE_FLIGHT","Uçuş yorumları");
define("_PHOTO","Fotoğraf");
define("_PHOTOS_GUIDELINES","Fotoğraflar JPG ve 100kb den küçük olmalı.");
...
define("_IGC_FILE_OF_THE_FLIGHT","Ucusun IGC dosyası");
define("_DELETE_PHOTO","Sil");
define("_NEW_PHOTO","Yeni fotoğraf");
define("_PRESS_HERE_TO_CHANGE_THE_FLIGHT","Uçuş bilgilerini değiştirmek için 
buraya tıklayınız");
...
//--------------------------------------------
define("_Upload_new_photo_or_change_old","Yeni bir fotoğraf ekle veya 
değiştir");
...
define("_Navigate_with_Google_Earth","Google Earth ile Uçuşunuzu Izleyiniz");
