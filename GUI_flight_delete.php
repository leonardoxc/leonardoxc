...
if ($confirmed && ($flight->userID==$userID || in_array($userID,$admin_users)))
{
	...
	echo '<div align="center"><br/>'
			._THE_FLIGHT_HAS_BEEN_DELETED.'<br/><br/>'
			.'<a href="?name='.$module_name.'&op=list_flights">'._RETURN.'</a><br/>'
		.'</div>';
}
else
{
	...
	echo '<div align="center"><br/>'
			.'<b>'
				...
				.$location
			.'</b><br/><br/>'
			.'<a href="?name='.$module_name.'&op=delete_flight&flightID='.$flightID.'&confirmed=1">'
				._YES
			.'</a>'
			.' | '
