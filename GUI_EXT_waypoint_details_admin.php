...
//
// $Id: GUI_EXT_waypoint_details_admin.php,v 1.8 2010/03/14 20:56:10 manolis Exp $                                                                 
//
//************************************************************************
...
$(document).ready(function(){
   // Your code here
	...
	$("#addToArea").click(function() {		
		...
		$("#resDiv").html("<img src='img/ajax-loader.gif'>");		
	  	$("#resDiv").load("<?=$moduleRelPath?>/EXT_takeoff_functions.php?op=addToArea&tID=<?=$waypointIDview?>&aID="+areaID ); 
    ...
    <td valign="middle">
      <table class="Box" width="530"  align="center">
        <tr align="center" bgcolor="#D0E2CD">
          <td width="133"><div id='addToArea'>Add to area</div></td>
          <td width="135">Area ID <input name="areaID" id='areaID' type="text" size="5" />
          </td>
          <td width="246"><div id='resDiv'></div></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <table class="Box" width="530"  align="center">
