...
//
// $Id: sync_new.php,v 1.1 2009/02/17 16:16:23 manolis Exp $                                                                 
//
//************************************************************************
	$getOnlyServersList="45,45,99";
	$CONF_server_id="99";
	echo $getOnlyServersList."<BR>";
			$getOnlyServersList=preg_replace("/[^,\d]/","",$getOnlyServersList);
			
			$getOnlyServersList=preg_replace("/$CONF_server_id([,|$])/","0$1",$getOnlyServersList);
			
			echo $getOnlyServersList;
