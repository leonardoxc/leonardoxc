...
/* 
 $CONF_NAC_list=array(
	5=>array(
		 'id'=>5,
		 'name'=>'Polish XC League',
		 'localName'=>'Polska liga XC',
		 'localLanguage'=>'polish',
		 'periodIsNormal'=>1 , // if league period doesnt start on 1/1 then =>0
		 'periodStart'=>"-10-01",	
...
//20160131 rgrubba ustawilem airspacechecks z 0 na 1
