...
/*
$Id: nusoap.php,v 1.1 2009/02/20 16:11:30 manolis Exp $
...
* @version  $Id: nusoap.php,v 1.1 2009/02/20 16:11:30 manolis Exp $
* @access   public
*/
class nusoap_base {
	/**
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (nusoap_client->response has contents of the response)");
			return false;
		}
